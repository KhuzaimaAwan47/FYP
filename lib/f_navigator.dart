              ...
              CustomNavigationBarItem(
                  icon: selectedIndex == 0 ?  Container(
                      decoration: BoxDecoration(
                        ...
                        color: Colors.deepPurple.shade50, // Background color of the circle
                      ),
                      child: const Icon (Icons.home_filled,)) : const Icon(Icons.home_outlined),
                title: selectedIndex == 0 ? const Text('Home',style: TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold,)) : const Text('Home'),
              ),
              CustomNavigationBarItem(
                ...
                title: selectedIndex == 1 ? const Text('Messages',style: TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold,)) : const Text('Messages'),
              ),
              CustomNavigationBarItem(
                ...
                title: selectedIndex == 2 ? const Text('Feed',style: TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold,)) : const Text('Feed'),
              ),
              CustomNavigationBarItem(
                ...
                title: selectedIndex == 3 ? const Text('Dashboard',style: TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold,)) : const Text('Dashboard'),
              ),
            ],
            onTap: _onItemTapped,
