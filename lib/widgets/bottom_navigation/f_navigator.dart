            ...
            child: CustomNavigationBar(
              ...
              items: [
                CustomNavigationBarItem(
                  ...
                  title: selectedIndex == 0 ? const Text('Home',style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold,)) : const Text('Home',style:
                ...
                CustomNavigationBarItem(
                  ...
                  title: selectedIndex == 1 ? const Text('Messages',style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold,)) : const Text('Messages',style:
                  TextStyle(color: Colors.grey),),
                ),
                CustomNavigationBarItem(
                  ...
                  title: selectedIndex == 2 ? const Text('Feed',style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold,)) : const Text('Feed',style:
                  TextStyle(color: Colors.grey),),
                ),
                CustomNavigationBarItem(
                  ...
                  title: selectedIndex == 3 ? const Text('Dashboard',style: TextStyle(color: Colors.indigo, fontWeight: FontWeight.bold,)) : const Text('Dashboard',style:
                  TextStyle(color: Colors.grey),),
                ),
              ],
              onTap: _onItemTapped,
